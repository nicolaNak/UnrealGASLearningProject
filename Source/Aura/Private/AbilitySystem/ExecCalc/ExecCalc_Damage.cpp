...
//Not working, returns value under 1.f every time when at level 1
                                              ...
                                              FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	//Get damage set by caller magnitude - all damage types
	float Damage = 0.f;
	...
	//Capture block chance on target and determine if there was a successful block - if block, halve the damage
	...
	//Double damage plus bonus is critical hit
